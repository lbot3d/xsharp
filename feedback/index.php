...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Tema pisma 1',
		'title' => 'Zagolovok v Tema pisma',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'info@lbot3d.ru',
		'from_name' => 'noreply',
		'to_email' => 'xxm@inbox.ru',
		'to_name' => 'noreply1',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
    ...
    if(count($error) == 0) {
      ...
      $get_fromEmail = (isset($form['fields'][$form['cfg']['from_email']]) && isset($getdata[$form['cfg']['from_email']]['value']) && mb_strpos('@', $getdata[$form['cfg']['from_email']]['value']) === false) ? $getdata[$form['cfg']['from_email']]['value'] : ((mb_strpos('@', $form['cfg']['from_email']) !== false) ? $form['cfg']['from_email'] : 'info@'.$host);
      ...
      $headers .= "X-Mailer: Feedback, v0.3 (http://lbot3d.ru)\r\n";
	  ...
	  /*$mail = mail("xxm@inbox.ru", "the subject", $sb['body'],"From: <webmaster@$SERVER_NAME\r\n>" ."Reply-To: webmaster@$SERVER_NAME\r\n" ."X-Mailer: PHP/" . phpversion());
		*/
      if($mail) {
          $jsonBox['ok'] = 1;
          $info[] = $form['cfg']['okay'];
